...
#EDIT THE FOLLOWING:
$toAddress = "oconnalla@gmail.com";  //place your/your client's email address here
$toName = "Ariel Oconnall"; //place your client's name here
$website = "arieloconnnall.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>
		<label>
			Name:<br /><input class="inputBorder" type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
	</div>
	<div>	
		<label>
			Email:<br /><input class="inputBorder" type="email" name="Email" required="required" placeholder="Email (required)" title="A valid email is required" tabindex="20" size="44" />
		</label>
	</div>
